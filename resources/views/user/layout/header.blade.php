...
<div id="kt_app_header" class="app-header d-flex flex-column flex-stack">
    ...
    <div class="d-flex flex-stack flex-grow-1">
        <div class="app-header-logo d-flex align-items-center ps-lg-12" id="kt_app_header_logo">
            ...
            <!--begin::Logo-->
            <a href="{{url('/user')}}" class="app-sidebar-logo">
        ...
        <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
            ...
            <div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
                ...
                <div class="cursor-pointer symbol symbol-circle symbol-30px symbol-lg-45px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-start">
                    <i class="fonticon-alarm fs-2"></i>
                                    <span class="position-absolute start-100 translate-middle badge badge-circle badge-danger w-15px h-15px ms-n4 mt-3" style="top: -10px !important">{{App\Models\Notification::where('destination_type', 2)->where('destination_id', auth('web')->user()->id)->whereNull('read_at')->count()}}</span>
                </div>
                <!--begin::Notification menu-->
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                    ...
                    {!! view('user.layout.notifications', ['notifications'=>$notifications->limit(10)->get()])->render() !!}

                     @endif
                    <div class="separator my-2"></div>

                    <div class="menu-item px-5 text-center">
                        <a href="{{route('user.messages.index')}}" class="menu-link px-5">مشاهدة المزيد</a>
                    </div>
                    <!--end::Menu item-->
                </div>
            ...
            <div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
                <!--begin::Menu wrapper-->
                <div class="cursor-pointer symbol symbol-circle symbol-30px symbol-lg-45px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-start">
                    @if (Auth::guard('web')->user()->getMedia('profile')->count())
                        <img src="{{Auth::guard('web')->user()->getFirstMediaUrl('profile')}}" alt="{{$settings->append_name}}" />
                    @else
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="symbol symbol-50px me-5">
                                @if (Auth::guard('web')->user()->getMedia('profile')->count())
                                <img alt="{{$settings->append_name}}" src="{{Auth::guard('web')->user()->getFirstMediaUrl('profile')}}" />
                                @else
                                    <img alt="{{$settings->append_name}}" src="{{asset('dash/assets/media/avatars/blank.png')}}" />
                                @endif
                            </div>
                            ...
                            <div class="d-flex flex-column">
                                <div class="fw-bold d-flex align-items-center fs-5">{{Auth::guard('web')->name}}</div>
                                <a href="javascript:;" class="fw-semibold text-muted text-hover-primary fs-7">{{Auth::guard('web')->user()->email}}</a>
                            </div>
                            <!--end::Username-->
                        </div>
                    </div>
                    ...
                    <div class="menu-item px-5">
                        <a href="{{route('user.users.show', Auth::guard('web')->id())}}" class="menu-link px-5">{{trans('auth.profile')}}</a>
                    </div>
                    ...
                    <div class="menu-item px-5">
                        <a href="{{route('user.logout')}}" class="menu-link px-5">{{trans('auth.logout')}}</a>
                    </div>
                    <!--end::Menu item-->
                </div>
