                    ...
                    <div class="card-body mt-n20">
                        ...
                        <div class="mt-n20 position-relative">
                            ...
                            <div class="row g-3 g-lg-6">
                                <!--begin::Col-->
                                <div class="col-6" onclick="window.location.href='{{route('supervisor.users.index')}}'" style="cursor: pointer">
                                    <!--begin::Items-->
                                ...
                                <!--end::Col-->
                                <!--begin::Col-->
                                <div class="col-6" onclick="window.location.href='{{route('supervisor.messages.index')}}'" style="cursor: pointer">
                                    <!--begin::Items-->
                                    <div class="bg-gray-100 bg-opacity-70 rounded-2 px-6 py-5">
                                        <!--begin::Symbol-->
                                        <div class="symbol symbol-30px me-5 mb-8">
                ...
                <div class="card card-flush h-lg-100">
                    ...
                    <div class="card-header pt-5">
                        ...
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bold text-dark">المستخدمين </span>
                            <span class="text-gray-400 mt-1 fw-semibold fs-6">احصائية المشتركين والمشرفين عليهم</span>
                        </h3>
                        <!--end::Title-->
                    </div>
                    <!--end::Header-->
