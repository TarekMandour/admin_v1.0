...
<div class="row mb-6">
    <label class="col-lg-4 col-form-label required fw-semibold fs-6">الجنسية عربي</label>
    <div class="col-lg-8 fv-row">
...
<div class="row mb-6">
    <label class="col-lg-4 col-form-label required fw-semibold fs-6">الجنسية انجليزي</label>
    <div class="col-lg-8 fv-row">
