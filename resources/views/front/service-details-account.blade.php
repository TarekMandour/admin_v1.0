       ...
       <div class="row">
           ...
           <div class="col-md-7">
               ...
               <div class="list-single-main-wrapper fl-wrap" id="sec2">
                    ...
                    @php
                        $users = \App\Models\OrderUser::where('user_id', auth()->guard('web')->user()->id)->where('service_id', $service->id)->get();
                    @endphp
                    @if (count($users) > 0)
                    <div class="list-single-main-item fl-wrap block_box">
                        <div class="list-single-main-item-title">
                            <h3>{{trans('lang.campaign_personnel')}}</h3>
                        </div>
                        <section class="small-padding no-top-padding-sec" id="sec1">
                            <div class="container">
                       ...
                       <div class="box-widget-content bwc-nopad">
                           <div class="list-author-widget-contacts list-item-widget-contacts bwc-padside">
                               <ul class="no-list-style">
                                   <li><span><i class="fal fa-tree"></i> </span> <a href="#"> {{trans('lang.target')}} {{$service->target}} </a></li>
                                   <li><span><i class="fal fa-map-marker-alt"></i> </span> <a href="#">{{$settings->append_address}}</a></li>
                               </ul>
                           </div>
                       </div>
