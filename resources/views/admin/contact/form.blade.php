...
<div class="row mb-6">
    <label class="col-lg-4 col-form-label required fw-semibold fs-6">رقم الجوال</label>
    <div class="col-lg-8 fv-row">
...
<div class="row mb-6">
    <label class="col-lg-4 col-form-label fw-semibold fs-6">البريد الالكتروني</label>
    <div class="col-lg-8 fv-row">
...
<div class="row mb-6">
    <label class="col-lg-4 col-form-label required fw-semibold fs-6">محتوى الرسالة </label>
    <div class="col-lg-8 fv-row">
