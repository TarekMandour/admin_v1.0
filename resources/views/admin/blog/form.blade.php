    ...
    <div class="col-lg-8">
        @if (isset($data) && $data->getMedia('photo')->count())
            @foreach($data->getMedia('photo') as $media)
                <div class="image-input image-input-outline m-5" data-kt-image-input="true" style="background-image: url({{asset('dash/assets/media/avatars/blank.png')}})">
                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{$media->getUrl('thumb')}})"></div>
