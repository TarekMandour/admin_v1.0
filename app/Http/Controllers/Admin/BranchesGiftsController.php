...
class BranchesGiftsController extends Controller
{
    protected $viewPath = 'admin.branchGift';
    private $route = 'admin.branchGift';

    public function __construct(BranchGift $model)
    {
