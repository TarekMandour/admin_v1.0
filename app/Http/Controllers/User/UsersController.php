...
{
    protected $viewPath = 'user.user';
    private $route = 'user.users';
    ...
    public function update(Request $request)
    {
        ...
        return redirect(route($this->route . '.edit', auth('web')->user()->id))->with('message', 'تم التعديل بنجاح')->with('status', 'success');
    }
