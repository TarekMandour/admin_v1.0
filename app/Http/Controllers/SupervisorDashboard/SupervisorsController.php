...
{
    protected $viewPath = 'supervisor.supervisor';
    private $route = 'supervisor.all_supervisors';
            ...
            return Datatables::of($data)
                ...
                ->addColumn('actions', function($row){
                    $actions = '<div class="ms-2">
                                <a href="'.route('supervisor.all_supervisors.show', $row->id).'" class="btn btn-sm btn-icon btn-warning btn-active-dark me-2" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                    <i class="bi bi-eye-fill fs-1x"></i>
                                </a>
                                <a href="'.route('supervisor.all_supervisors.edit', $row->id).'" class="btn btn-sm btn-icon btn-info btn-active-dark me-2" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                ...
                ->rawColumns(['checkbox','name','phone','is_active','actions'])
                ->make(true);
        }
